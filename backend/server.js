...
// Melayani file statis dari folder build React
app.use(express.static(path.join(__dirname, 'build')));

// Rute fallback untuk semua permintaan lainnya
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, 'build', 'index.html'));
});

// Koneksi ke MongoDB
mongoose.connect('mongodb+srv://raihanmian1:QR6Wy9dc16v0av0u@a9.51umb.mongodb.net/?retryWrites=true&w=majority&appName=A9', {
